...
<template>
  <div class="basis-1/2 bg-white mx-5 my-2 p-5 max-w-[530px] rounded-md shadow-lg group">
    ...
    <p class="pb-2 text-slate-600"> {{ description }} </p>
    <nuxt-link class="group-hover:text-sky-500" :to="path">
      <p class="font-medium">
        더보기 {{ path }}
